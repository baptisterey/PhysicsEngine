...
void BallSpawner::SpawnUltraBallSpring()
{
	...
	newEntity->GetTransform()->SetPosition(Vector3(150, 270, 0));

	newEntity->GetComponentByType<ParticleRenderer>()->SetTexture(ultraballTexture);

	Entity* newEntity2 = EntityManager::CreateEntity("BasketBall", { new Particle(Vector3(10, 0, 0), 1, 0.1f, 0), new ParticleRenderer(), new Spring(0.5f, 50, newEntity->GetTransform()->GetPosition()) });
	newEntity2->GetTransform()->SetPosition(newEntity->GetTransform()->GetPosition());
...
void BallSpawner::SpawnSuperBallBuoyancy()
{
	...
	newEntity->GetTransform()->SetPosition(Vector3(350, 300, 0));
	...
	newEntity->GetTransform()->SetPosition(Vector3(350, 250, 0));
...
void BallSpawner::SpawnSuperBallRod()
{
	...
	newEntity->GetTransform()->SetPosition(Vector3(400, 350, 0));
